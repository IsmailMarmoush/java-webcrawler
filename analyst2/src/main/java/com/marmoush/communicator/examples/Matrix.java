...
public class Matrix {
	...
	private static Traverser getFriends(final Node person) {
		return person.traverse(Order.BREADTH_FIRST, StopEvaluator.END_OF_GRAPH,
	...
	public String printMatrixHackers() {
		...
		for (Node hackerNode : traverser) {
			output += "At depth " + traverser.currentPosition().depth()
	...
	public String printNeoFriends() {
		...
		for (Node friendNode : friendsTraverser) {
			output += "At depth " + friendsTraverser.currentPosition().depth()
