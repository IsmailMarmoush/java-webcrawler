...
import com.marmoush.communicator.validation.MailServersResponse;
...
public class MailServer implements Comparable<MailServer> {
	...
	public static List<MailServer> getMailServers(Node domain) {
		String url = (String) domain.getProperty(Group.NODE_KEY);
		return MailServersResponse.getMailServers(url);
	}
}
